...
public abstract class HotSpotHostForeignCallsProvider extends HotSpotForeignCallsProviderImpl implements ArrayCopyForeignCalls {
    ...
    public static final HotSpotForeignCallDescriptor SCALE_CPU_FREQ = new HotSpotForeignCallDescriptor(LEAF_NO_VZERO, NO_SIDE_EFFECT, NO_LOCATIONS, "scaleCpuFreq", long.class, long.class);
